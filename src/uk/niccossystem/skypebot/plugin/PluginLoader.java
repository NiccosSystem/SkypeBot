...
public class PluginLoader {
	...
	private HashMap<String, String> realJars;
	private HashMap<String, URLClassLoader> loadList;
	...
	public void scanForPlugins() {
		...
		if (pluginsF == null) return;
		
		for (String fileName : pluginsF.list()) {
			if (!fileName.endsWith(".jar")) continue;
			if (!scanPlugin(fileName)) continue;
			if (!pluginsToLoad.contains(fileName)) pluginsToLoad.add(fileName);
